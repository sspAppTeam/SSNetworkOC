...
Pod::Spec.new do |s|
  s.name             = 'SSNetworkOC'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SSNetworkOC.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SSPSource/SSNetworkOC'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SSPSource' => '2316585240@qq.com' }
  s.source           = { :git => 'https://github.com/SSPSource/SSNetworkOC.git', :tag => s.version.to_s }
